...
{
  char tmpstr[500];
  sprintf(tmpstr, "xBlinds v%s<br><br>stepperlastpreset: %s<br>stepperhome: %d<br>stepperhalf: %d<br>stepperopen: %d<br>stepperfull: %d<br>overridehalf: %d<br>steppercurrentpos: %d<br>tiltpos: %d<br>lastmove: %s<br>stepsize: %d", 
  xbversion, stepperlastpreset, stepperhome, stepperhalf, stepperopen, stepperfull, overridehalf, steppercurrentpos, tiltpos, lastmove, stepsize);
